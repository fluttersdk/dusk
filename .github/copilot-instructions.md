...
4. **README sync**. When a change is significant enough for the package landing page (new command, new MCP tool, new VM extension, breaking change), update `README.md`. Use descriptive link labels pointing at `https://dusk.fluttersdk.com/...` paths.
